...
public class NewsListAdapter extends BaseExpandableListAdapter {
    ...
    private ArrayList<News> mParent;
 
    public NewsListAdapter(Context context, ArrayList<News> parent){
        mParent = parent;
    ...
    public View getGroupView(int i, boolean b, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            view = inflater.inflate(R.layout.news_list_item_parent, viewGroup,false);
        }
 
        TextView textView = (TextView) view.findViewById(R.id.list_item_text_view_news);
        TextView dateView = (TextView) view.findViewById(R.id.list_item_text_view_news_date);
    ...
    public View getChildView(int i, int i1, boolean b, View view, ViewGroup viewGroup) {
        if (view == null) {
            view = inflater.inflate(R.layout.news_list_item_child, viewGroup,false);
        }
 
        TextView textView = (TextView) view.findViewById(R.id.list_item_text_child_news);
